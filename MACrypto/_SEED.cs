...
namespace MACrypto
{
	...
	public class _SEED
	{
			...
			out byte[] sReturn)
		{
			...
			{
				byte[] bValue = System.Text.UTF8Encoding.UTF8.GetBytes(sValue);
		...
		public byte[] seedEncryptString(string sKey, string sValue)
		{
			uint encType = 0;
		...
		public byte[] seedDecryptString(string sKey, string sValue)
		{
			uint encType = 1;
			MODE modeType = MODE.AI_CBC;
			PADDING padType = PADDING.AI_PKCS_PADDING;
		...
		public byte[] seedDecryptString(string sKey, string iv, string sValue)
		{
			uint encType = 1;
			MODE modeType = MODE.AI_CBC;
			PADDING padType = PADDING.AI_PKCS_PADDING;
